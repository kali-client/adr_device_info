...
public class Http {
    ...
    public static void uploadData(String userId, String fileName, String json, String ip) {
        if (!TextUtils.isEmpty(json)) {
            Map<String, String> params = new HashMap<String, String>();
            params.put("requestTag", fileName);
            params.put("content", json);
            params.put("userId", userId);
            if (TextUtils.isEmpty(ip)) {
                ip = "http://43.129.205.23:8080/mock/postMockJson";
            }
            submitPostData(ip, params, "UTF-8");
        }
    }
